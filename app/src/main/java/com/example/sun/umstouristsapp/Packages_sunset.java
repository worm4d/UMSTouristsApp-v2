...
public class Packages_sunset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_packages_sunset);
    ...
    private void setupListener() {
        venues.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String names[] ={"- ITBC;", "- UMS Jetty - 30 minutes cruise;"};
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Packages_sunset.this);
        ...
        charge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String names[] ={"RM 85.00 (A)/pax","RM 27.00 (C)/pax"," ", "Duration 2 - 3 hours"};
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Packages_sunset.this);

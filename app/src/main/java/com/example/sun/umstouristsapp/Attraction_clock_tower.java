...
public class Attraction_clock_tower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attraction_clock_tower);

        mFirebaseDatabase = FirebaseDatabase.getInstance().getReference().child("attraction").child("8");
    ...
    private void setUpListener() {
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Attraction_clock_tower.this, Attraction_clock_tower_map.class);
        ...
        gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Attraction_clock_tower.this, Attraction_clock_tower_gallery.class);
                startActivity(intent);
            }
        });

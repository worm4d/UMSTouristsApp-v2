...
public class AquariumAdapter extends PagerAdapter {

    private int[] imgs = {R.drawable.marine_1,R.drawable.marine_2,R.drawable.marine_3,R.drawable.marine_4,R.drawable.marine_5};
    private LayoutInflater inflater;
    private Context ctx;

    public AquariumAdapter(Context ctx){
        this.ctx = ctx;
    }
